...
ecosistemas es el estudio de la red de interacciones (.\@.barrios2007,
...
de la fauna del suelo, se compararán las métricas estruturales, los
...
se establecen a partir de la evidencia empírica ($gamma\; [\gamma]$). A cada interacción se asignaron
...
estos actores sobre el 48% de la biomasa media de los
...
y su peso son iguales a 1 a los fines de realizar cálculos de fuerzas de interacción y flujos de energía (.\@.pawar?; .\@.alesina; .\@.fluxweb).
...
interacción en Joules/año (\@gauzen, \energeticalfoodweb).
...
la red trófica en cuestión, entonces realiza aleatorizaciones de las fuerzas
...
nodos (\@Delmasetal2019), para cada aleatorizacion producto del algoritmo; para una red
trófica el valor de estabilidad de quasisigno es el valor del máximo autovalor (i.e. más
cercano a cero) este es una medida de estabilidad dando la
