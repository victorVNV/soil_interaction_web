...
de correlación, la longitud de un camino trófico, etc., al mismo tiempo también determinan 
...
la densidad aparente media de los suelos ($\text {DAP} = 1,2 \;\frac{g}{cm^2} $)
y referidas hasta los 10 centímetros de profundidad, 
...
de los nemátodos de cada categoría trófica en suelos de Luján, por lo tanto, nemátodos
...
la tasa metabólica estimada mediante $\text{tasa metabólica} = 17.17\; peso^{-0.29}$, 
...
nodos (\@Delmasetal2019), para cada aleatorizacion producto del algoritmo; una red
...
mRO_rec[mRO_rec$specie=="humus","BT"]<-1*1e6
...
vegetal que engloba a las raices y sus exudados, la hojarasca el tejido vegetal en proceso de fragmentación y descomposición, el humus materia orgánica en avanzado estado de descomposición y que conforma enlaces con la fracción mineral de los coloides de la arcilla del suelo
...
<!--en chivilcoy hay 7 predadores y en luján 13
