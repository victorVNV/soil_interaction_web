...
dejar carroña una vez sucedida su decesión, finalmente el tejido vegetal que incluye 
raices y exudados (Cap 2.1. Recursos tróficos) no pudo ser determinado.
...
cuales existe pequeños agrupamientos, denominados también como "camarillas", entre nodos
en la red.
...
<!-- TASA de INGRESO: Indica que en suelos de la Pampa Ondulada y en la region de la provincia en la cual nos 
ubicamos, la incorporacion de materia orgánica anual es de 6 tn de C/ha * año con una
relacion del C del 40% de la vegetación. Roberto Alvarez, MATERIA ORGANICA, valor agronomico y dinamica en suelos pampeanos. pp.34 

pp.56 indica que la perdida de C-CO2 es 7,9 tn/haaño descomposición y mineralizacion
pp. 57 usando C14 se establece el coef de humificacion del C, que es del 0.5 in situ
coeficiente de mineralizaión media del humus del 5,7% anual
En la figura 5.3 el aporte del carbono es de 4,3 tn/ha/año del rastrojo y 1,9 tn/ha/año para las raices 
los residuos pierden a la atmosfera 3,1 y 3,1 va al humus-->
...
```{r cb_qss,include=FALSE}
#cb_qss_R<-calc_QSS(cB_R,istrength=TRUE,nsim=100)
```
