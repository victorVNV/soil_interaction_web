...
relativas a los nodos de la red. El **tamaño de la red** que indica el
...
potenciales del grafo con el mismo tamaño; el **agrupamiento o
clustering** mide un coeficiente que indica la magnitud en los cuales
...
encuentra una especie trófica, aquí se indican el **nivel trófico
medio** de la red y el **nivel trófico máximo** de la red; se
...
trófico, respectivamente, además se calcula el desvío estandar de ambas.
...
**Histogramas del valor de estabilidad en escala logaritmica calculado a
partir de la intensidad de interacciones**
...
ks.test(QSS_IS_R.r$maxre,QSS_IS_L.r$maxre)
ks.test(QSS_IS_R.r$maxre,QSS_IS_P.r$maxre)
ks.test(QSS_IS_L.r$maxre,QSS_IS_P.r$maxre)
# L: 0.414; R: 0.348; P: 0.371, ¿En que difieren a lo largo de la distribución?
#Diferencias con el pastizal que obtuvo el menor valor de autovalor

print(adjusted_p_val_luj,adjusted_p_val_ro,adjusted_p_val_ro)
```
