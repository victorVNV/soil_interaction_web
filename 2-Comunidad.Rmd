...
#summary(f_pca)
##corelaciones
f_pca_cor<-round(f_pca$var$cor[,1:3],3);
print("-----------------------------");
#print(f_pca_cor)
...
print(data.frame(habitats=levels(as.factor(paste(mesoabH$sitio,mesoabH$estrato))),
                 ...
                 desvio_std=c(
                   ...
                   (as.matrix(mesoabH[mesoabH$sitio=="P" & mesoabH$estrato=="hoja","diversidad"])),
...
fviz_pca_biplot(std_ab_pca, axes = c(1,2),  col.ind=col.sp, col.var = sit,repel = TRUE,label = "none")
