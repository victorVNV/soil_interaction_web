...
base%>%mutate( Sitio= factor(system),gremio = factor(guild, levels = c("detritivore","microphytophages",
                                                      "omnivore","predator")
                                   ,labels=c("Detritívoros","Microfitófagos","Omnívoros","Depredadores")))%>%
  ggplot(aes(x=log(bio.ind),y=log(abundance),color=Sitio))+
