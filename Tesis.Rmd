...
La Pampa Ondulada es una región de gran importancia para la producción agropecuaria en Argentina, caracterizada por su clima templado, topografía plana, suelos ricos en materia orgánica y bien drenados que la consolidan cómo un pilar fundamental de la economía del país. Sin embargo, desde el siglo pasado diversos autores ya advierten sobre la degradación de la fertilidad de estos suelos debido a las prácticas agrícolas intensivas que afectan tanto a la estructura física como a la fertilidad química y biológica del suelo.

Aunque existe un conocimiento integrado sobre los componentes físicos y químicos de los suelos, la información sobre la biodiversidad edáfica es todavía limitado. Se estima que en los suelos se encuentra el 59% de la biodiversidad global, pero de ésta sólo se conoce una minúscula fracción.

Es importante conocer la vida “bajo nuestros pies”, es decir la diversidad biológica que ocurre en la intrincada matriz orgáno-mineral del suelo. La biodiversidad interviene tanto en la formación del suelo y su estructura como en el mantenimiento y el funcionamiento de los mismos mediante las interacciones entre los organismos y el medio ambiente edáfico.
Por lo tanto es esencial avanzar en la investigación sobre la biología y ecología del suelo para comprender cómo la biodiversidad se ve afectada por los disturbios, derivados de la actividad antrópica, que alteran el hábitat y la disponibilidad de recursos y cómo se 
relacionan con los procesos que sustentan la funcionalidad de estos ecosistemas.

La comunidad de la fauna edáfica ocupa los espacios que se forman entre la hojarasca, troncos, piedras, que se acumula sobre la superficie del suelo y los poros de la matriz órgano-mineral del suelo. Estos animales habitan principalmente los primeros centímetros del suelo y son clasificados tradicionalmente según un rango de tamaño corporal en microfauna, mesofauna y macrofauna.

La fauna edáfica desempeña un papel fundamental en el funcionamiento del suelo a diferentes escalas espacio-temporales mediante el consumo de materia orgánica, el transporte de propágulos de bacterias y hongos, el control de poblaciones, son los recursos tróficos de la fauna zoofaga y tienen la capacidad de modificar la estructura órgano-mineral del suelo. Sus funciones están interrelacionadas con la ecología trófica. A su vez, estas interacciones contribuyen con funciones ecosistémicas que influyen sobre la dinámica del ciclo del carbono, de los nutrientes y el agua, la formación de estructura y la regulación de poblaciones.

Entender la complejidad de estos sistemas ecológicos edáficos es una cuestión clave para mantener características que aseguren y aumenten los beneficios ecosistémicos provistos por el suelo, tales como el mantenimiento de la fertilidad, el aumento de la captura de carbono,
el control de plagas y enfermedades, la generación de hábitats y la 
protección de la biodiversidad que podría resultar clave en la obtención 
de nuevos desarrollos y tecnologías de interés medicinal e industrial o en procedimientos de remediación ambiental, entre otros.

La comunidad de la fauna edáfica responde al efecto de las perturbaciones naturales y antrópicas mediante cambios en los rasgos funcionales, cambios en la estructura poblacional, en la composición taxonómica o en otros atributos de la comunidad. Por lo que conocer esta respuesta nos permitirá entender sobre el funcionamiento de las redes tróficas de las comunidades edáficas que habitan estos suelos de la Pampa Ondulada. 

En esta tesis se aborda el estudio de las redes de interacciones, en particular de las redes tróficas que mediante herramientas matemáticas permiten entender la complejidad de los sistemas ecológicos. Así, se busca entender el funcionamiento de las comunidades de la fauna edáfica de suelos  de la Pampa Ondulada bajo diferentes intensidades de impacto antrópico del suelo.
El análisis de las redes tróficas permite integrar la diversidad de la comunidad, interacciones interespecíficas, rasgos funcionales, características topológicas, características funcionales vinculadas con la multiplicidad de canales de materia y energía e inferir sobre el valor de estabilidad de la comunidad.

El objetivo de la tesis es construir las redes tróficas de la fauna edáfica
que ocurren en suelos bajo diferentes intensidades de uso en la Pampa Ondulada Argentina, para analizar las características funcionales de las comunidades edáficas y su estabilidad.
...
Por otra parte, se resalta que la información a nivel global es escasa y fragmentaria, centrada principalmente en suelos europeos, dejando un vacio de conocimiento .

b)  Conocer la diversidad de las comunidades de la fauna edáfica que habitan los suelos de interés y de manera complementaria caracterizar el ambiente edáfico en el cuál habitan. Se tomaron muestras de suelos  en el campo experimental de la Universidad Nacional 
de Luján bajo diferentes intensidades en el uso del suelo, uso “nulo”, 
uso “leve”, uso “intensivo”. Se determinaron variables químicas del suelo 
y la respiración heterotrófica. Se extrajeron, identificaron taxonómicamente
y se midieron rasgos morfológicos corporales de la microfauna, la mesofauna y la macrofauna. De manera complementaria se utilizó un set de datos con parámetros similares que incluyen microartrópodos y lombrices solamente. Se observó que, a pesar de las distancias geográficas entre los conjuntos de datos, el uso intensivo del suelo provocó acidificación del medio y 
reducción en la respiración heterotrófica. Además, las comunidades 
fueron diferentes reflejando las adaptaciones a los suelos con diferentes 
intensidades de uso aunque el valor de la diversidad entre ellos resultó ser similar. 
El Capítulo 3 de esta tesis presenta esa información y análisis.

c)  Obtener información sobre el peso corporal de los taxones que componen la fauna del suelo, objeto del Capítulo 4. Para ello cada uno de los 11880 individuos previamente identificados fueron fotografiados y medidos para estimar su peso corporal individual. Esto permitió analizar el espectro de tamaños y su respuesta ante las perturbaciones en ambos conjuntos de datos. Se encontró que las comunidades de la fauna edáfica mantienen la relación de las biomasas
y del espectro de tamaños en valores similares entre los diferentes sistemas de uso del suelo. A través de los gremios tróficos se describió una pirámide de biomasa donde los detritívoros forman la base luego los microfitófagos, omnívoros, depredadores y herbívoros.

d)  En el Capítulo 5 se construyen las redes de interacciones en los diferentes usos del suelo
y se realiza su análisis. Se utilizó la información bibliográfica sobre las dietas potenciales de la edafofauna, el peso corporal, la densidad y la biomasa de los taxones en las comunidades analizadas. Con esta información fue factible calcular las características topológicas de la red trófica, los flujos de energía, las fuerzas de interacciones y se estimó el valor de estabilidad de las comunidades de la edafofauna bajo diferentes usos del suelo. Se observó que las redes tróficas de la fauna del suelo, a través de los diferentes sistemas de uso del suelo, compartieron valores cercanos en sus métricas topológicas tales como el número de niveles tróficos, el porcentaje de omnivoría, valores de generalidad y vulnerabilidad, entre otros. Con respecto a los flujos de energía, se estimó en el sistema agrícola un descenso significativo del mismo. Funcionalmente, en estas redes tróficas, la mayor cantidad del flujo de energía llega a la microflora, lo que explica porqué el sistema agrícola mostró los menores valores. Por otro lado, la mayor cantidad de energía fluye desde la materia orgánica del suelo (humus), canal de energía vinculado con la formación de agregados y con el ciclo de los nutrientes. Sigue en importancia la microfitofagia, con el consumo de microflora por parte de la fauna, la detritivoría con flujos de energía por debajo del 5% y la zoofagia en el cual los omnívoros participan con mayor importancia relativa. Por último, se estimó que la red más estable, aquella que requiere de una menor autoregulación, ocurrió en las redes tróficas de la fauna detritívora en suelos bajo agricultura intensiva, luego en pastizales y por último en el suelo sin impacto antrópico apreciable.

El estudio de las redes tróficas de la edafofauna, nos indica que las comunidades analizadas son resilientes ante el efecto de las perturbaciones que resultan del uso del suelo. Se mantienen cercanos los valores de la diversidad, la relación del espectro de tamaños y la topología de las redes. Si interpretamos las diferencias en estabilidad como diferencias en autorregulación, las redes tróficas sin impacto requieren una alta autorregulación para mantener sus poblaciones. En cambio, en las redes afectadas por disturbios antrópicos, dicho disturbio sustituye la autorregulación, lo que permite cuantificar el impacto del manejo agrícola. Además, el manejo agrícola del suelo lleva a la acidificación del suelo y la disminución de la actividad respiratoria y como respuesta la comunidad muestra cambios en la composición de los taxones y una disminución marcada del flujo de energía. Esta disminución  
puede afectar a los procesos midiados por la fauna edáfica y derivar en cambios en la funcionalidad ecosistémica afectando los ciclos biogeoquímicos en el suelo.
...
The responses of soil fauna to both natural and anthropogenic disturbances manifest as structural and functional changes, which are critical for understanding the behavior of food webs. This understanding is particularly relevant to the Rolling Pampas region of Argentina. With more than 54 million hectáreas, the central plains of Argentina are among the most extensive and fertile agricultural soils in the world, of which the Rolling Pampa covers around 6.6 million hectáreas. Ensuring the sustainability of these ecological systems is vital for preserving ecosystem services such as soil fertility, carbon sequestration, agricultural productivity, and biodiversity.

This thesis investigates the food webs of edaphic fauna in  soils under varying levels of anthropogenic impact in the Rolling Pampa. The objective was to construct food webs to analyze the influence of diversity, interactions, and functional traits on the topology, energy flows, and stability of the detritivore system. This allows inferences about the soil's functionality and conservation status.
...
En el suelo existe una intrincada red de poros e intersticios que se forman entre la matriz órgano-mineral y la hojarasca que se acumula sobre este. La red de poros (Fig. 1.2) es un entorno anfibio, compacto, discontinuo y de diámetro variable. Sus características físicas y químicas heterogéneas permiten el desarrollo y mantenimiento de una gran cantidad de microclimas que soportan una compleja y diversa comunidad biológica [@lavelle2012; @bardgett2002]. Adaptados a vivir en los poros, los organismos edáficos desarrollaron diferentes estrategias en sus formas de vida, fisiología y de alimentación, además desarrollaron relaciones mutualistas y poseen la capacidad de modificar las características de su entorno, lo que les permite evitar la competencia interespecífica y mantener sus poblaciones [@lavelle2012; @lavelle2006; @briones2014;@Potapov2022].
...
El enfoque que integra la diversidad en una comunidad, las interacciones interespecíficas, las relaciones con el ambiente, la redundancia funcional, el papel de las especies clave y los canales de materia y energía en los ecosistemas es el estudio de las redes de interacciones [@creamer2022; @briones2014; @potapov2022; @barrios2007]. Entre estas, las
...
Por el potencial para integrar las características antes mencionadas, Potapov [-@potapov2022] declara que el uso de las redes tróficas es una herramienta esencial que debe ser utilizada en los ecosistemas terrestres para comprender el funcionamiento del ecosistema del suelo. Las redes modelan cientos de interacciones tróficas y enlazan propiedades emergentes de las comunidades y de los ecosistemas [@delmas2019; @zotero-1438; @Hooper2005] que permiten analizar relaciones entre la dinámica, la estabilidad y la resiliencia de las comunidades [@Pimm1982]. En las comunidades de la fauna edáfica, éstas vinculan los procesos tróficos con el funcionamiento del suelo [@potapov2022;@sabatte2011; @kardol2016] y particularmente en los suelos  de la Pampa Ondulada, que soportan una alta presión productiva [@hall1992; @lavado2009] su análisis permitirá evaluar cómo responden las redes tróficas ante los disturbios. 
...
### Métodos utilizados para la identificación de los recursos tróficos
...
**Figura 2.2.** Métodos utilizados en la literatura para asignar recursos tróficos a microartrópodos del suelo. Los colores dentro de las columnas se refieren al número de registros en los diferentes niveles taxonómicos para los cuales cada método asignó al menos un recurso. ensayos: pruebas y observaciones de laboratorio. isotopos: isótopos estables. gut: contenido intestinal. enzimas: enzimas digestivas. bucal: morfología de las piezas bucales. lípidos: perfil lipídico. mo. det: detección molecular del contenido intestinal, f.p.: ensayos de preferencia alimentaria. obs.: observaciones directas en laboratorio sobre la actividad alimenticia. revisiones: revisiones generales de otros autores.
\vspace{0.7cm}
...
# Biología trófica y uso de los recursos de los principales taxones de la fauna edáfica.
...
# Análisis de la comunidad de la fauna edáfica en suelos con distinta intensidad de uso
...
Además, por su diversidad trófica y funcional, se relaciona con el control de las poblaciones y con
la distribución y transporte de esporas y propágulos de la microflora del suelo. Por otro lado, contribuye a la formación de microagregados, mediante la deposición de sus excretas líquidas o sólidas, que son almacén de carbono en el suelo. 
...
a suelos de los partidos de Chivilcoy - Navarro (Tabla 3.1; Apéndice 3). 
...
### Caracterización química - biológica de los suelos
...
**Tabla 3.3.** Variables químicas. Valores promedio y desvío estándar del pH, el porcentaje de materia orgánica (%MO), el porcentaje de nitrógeno (%N) y el fósforo asimilable (P~ppm~). Las letras distintas representan diferencias significativas
...
y el sistema agrícola difirió significativamente con valores 6,7 veces mayores.
Por su parte, en los suelos  de Chivilcoy - Navarro, la variación del fósforo entre los sistemas de uso del suelo no mostraron diferencias significativas.

Se observaron (Tabla 3.4) diferencias significativas en la respiración heterotrófica en las diferentes intensidades de uso del suelo. En suelos de Luján, se observó un gradiente con una mayor actividad 
...
\newpage
**Tabla 3.4** Variables biológicas. Valores promedio y desvío estándar de: la respiración heterotrófica edáfica en mg C-CO~2~/gr~suelo~.día, la relación hongos:bacterias y la biomasa de la hojarasca en gramos. Las letras distintas representan diferencias significativas evaluadas mediante la prueba de Kruskall-Wallis, entre intensidades de usos de suelo
...
### Diversidad de las comunidades de la fauna edáfica
...
con lo observado en Chivilcoy - Navarro. En Luján, tanto para sarcoptiformes como para mesostigmatas los mayores valores
se observaron en la reserva y en el pastizal. En el pastizal de Luján los prostigmatas tuvieron los
...
#### Análisis de similitudes de las comunidades de la fauna edáfica


El análisis de similitudes (ANOSIM) indicó que, 
en ambas localidades, existieron disimilaridades 
...
#### Análisis de multidumensional de las comunidades de la fauna edáfica
...
los tardígrados. Los colémbolos se correlacionaron con el sistema del pastizal.
...
efectos negativos sobre la diversidad de la fauna del suelo principalmente 
...
determinar el efecto de las prácticas de manejo sobre la diversidad de las 
comunidades, estimada a mayores resoluciones taxonómicas.
...
# Análisis de la biomasa y del espectro de tamaños de la fauna edáfica en suelos con distinta intensidad de uso
...
la diversidad, las funciones ecológicas y factores de interés 
bajo estudio (p. ej. intensidad de 
...
El rasgo funcional\footnote{Los rasgos funcionales son atributos morfológicos, fisiológicos o fenológicos de los organismos que afectan su demografía, es decir, su establecimiento, crecimiento, supervivencia y fecundidad. Estos rasgos determinan la eficacia biológica de los organismos y su éxito bajo determinadas condiciones ambientales} que permite relacionar la respuesta fisiológica de los organismos 
...
a través de los taxones o grupos funcionales [@white2007; @allen2006] sin requerir identificaciones taxonómicas hasta especie.
...
El objetivo de este capítulo es conocer cómo varían la biomasa media y el 
espectro de tamaños de 
la fauna edáfica que habitan suelos de la Pampa Ondulada sometidos a diferentes sistemas de manejo.
<!--Para conocer la respuesta diferencial de las comunidades edáficas en estos suelos es necesario determinar la variabilidad en la distribución de los pesos corporales debida a la escasez de datos sobre pesos corporales de la criptofauna en la región.-->Con esta estrategia, la construcción del espectro de tamaños de la comunidad de la edafofauna y sus gremios tróficos permitirá analizar los efectos de la intensidad de uso del suelo debido al manejo antrópico.

Se espera que, en función de la intensidad de uso del suelo, tanto la comunidad
como los gremios tróficos respondan con disminuciones en la biomasa y 
con pendientes del espectro de tamaño negativas.
Entonces sistemas de referencia donde la intensidad
de uso del suelo es nula, las comunidades y sus gremios tróficos 
tendrán biomasas medias mayores y la pendiente del espectro de tamaños 
tendrá valores cercanos a cero.

## Metodología

### Sitios de estudio y diseño de muestreo

Las comunidades de la fauna del suelo fueron muestreadas en suelos  bajo diferentes intensidades de uso antrópico. Se tomaron muestras de la comunidad de la fauna edáfica en el partido de Luján durante el año 2022, en suelos con manejo agrícola intensivo, un sistema de pastizal con pastoreo poco frecuente y una clausura de más de 30 años sin uso antrópico, y de ella se obtuvieron la microfauna, la mesofauna y la macrofauna. Además se utilizó el set de datos y los microartrópodos de la mesofauna obtenidos de suelos de Chivilcoy - Navarro durante los años 2008 y 2009, en suelos con manejo agrícola intensivo, manejo mixto agrícola ganadero y pastizales naturalizados sin uso antrópico por más de 50 años. Más detalles sobre los sitios de estudios y sus características, sobre el diseño de muestreo y sobre la extracción de la fauna edáfica se desarrollaron en el capítulo 3 de esta tesis.
...
taxones que integran los gremios de la fauna edáfica según el sistema de uso de suelo.
...
Los pesos corporales en esta categoría estuvieron entre los $0,4\mu g$ y los $4000 \;\mu g$,
...
La macrofauna tuvo una distribución de tamaños de 10 órdenes de magnitud con pesos corporales en un rango entre los $12 \mu g$ hasta los $270000 \;\mu g$. La forma de las distribuciones de este grupo de la fauna edáfica no es unimodal y esto está relacionado con la baja abundancia de la mayoría de los taxones observados y con la jerarquía taxonómica considerada (Fig 4.4).


![](Figures/Fig4-5.png){width=600 heigth=800}

**Figura 4.4.** Distribución del peso corporal de la macrofauna edáfica encontrados en suelos de Luján. Se muestra sobre el eje horizontal la escala en logaritmo natural del peso corporal en microgramos de peso seco. Sobre el eje vertical se indica el taxón. Los colores representan al gremio trófico al cual pertenece el taxón
\vspace{0.7cm}


Las lombrices del género *Aporrectodea* tuvieron pesos corporales medios 
en un rango de $225000 \;\mu g$ hasta los $119000 \;\mu g$ (Tabla 4.4). La mayor biomasa media del género se observó en el sistema agrícola con la especie *A. caliginosa*. El mayor peso corporal medio ocurrió en el sistema agrícola representado
por *A. trapezoides*, esta especie también registró la mayor densidad del género en la reserva. 
Los demás géneros y especies solo estuvieron presentes en uno de los tres sistemas, *Octolasion cyaneum* 
...
los áfidos, dípteros, Diplopoda y Lycosidae en el agrícola. A demás se observaron 6, 5 y 3 taxones con ocurrencias únicas en la reserva, el pastizal y el agrícola respectivamente (Tabla 4.4).

**Tabla 4.4.** Valores de peso corporal promedio ($ug_{p.s.}$), densidad ($no. ind/m^2$) y biomasa total media ($mg_{p.s.}/m^2$) de la macrofauna de suelos  de Luján
...
También se observó este fenómeno en algunos taxones de detritívoros y microfitófagos (Fig 4.5).


![](Figures/Fig4-4.png){width=600 heigth=800}
**Figura 4.5.** Distribución del peso corporal de los microartrópodos edáficos ocurridos en suelos  de Chivilcoy y Navarro. Se muestra sobre el eje horizontal la escala en logaritmo natural del peso corporal en microgramos de peso seco. Sobre el eje vertical se indica el taxón. Los colores representan al gremio trófico al cual pertenece el taxón
\vspace{0.7cm}


Los ácaros de la familia Acaroidea no se observaron en el sistema del pastizal naturalizado, esta familia muestra la mayor biomasa en el sistema mixto agrícola ganadero (Tabla 4.5).
...
**Tabla 4.5.** Valores de peso corporal promedio ($ug_{p.s.}$), densidad ($no. ind/m^2$) y biomasa total media ($mg_{p.s.}/m^2$) para los microartrópodos de suelos  de Chivilcoy - Navarro
...
### Análisis de la biomasa media de la fauna edáfica en suelos con distinta intensidad de uso
...
### Espectro de tamaños de la fauna edáfica en suelos con distinta intensidad de uso


#### Suelos de Luján

En los suelos de Luján el modelo del espectro de tamaños
indicó que existe un efecto significativo 
...
En el gremio de los detritívoros se observó que las densidades de la mesofauna y de la macrofauna se separan a lo largo del eje y indicando mayores densidades para la categoría de la mesofauna. En términos de pesos corporales promedios (eje x) se observaron rango de pesos superpuestos entre organismos de la mesofauna de mayor peso corporal y la macrofauna de menor peso corporal. El gremio de los microfitófagos, a lo largo del eje y mostró una estructura escalonada, con los nemátodos siendo los de mayor abundancia, seguidos por la mesofauna y luego de una "brecha" en los valores de la densidad
...
alrededor de un valor particular que podría estar relacionado con la dominancia 
...
tuvieron taxones con valores más altos de estas tres variables principalmente en el 
sistema cuyas intensidades de uso 
...
o estrategias para escapar de la depredación [@vandermeer1972; @Chase2011]. En este 
estudio se observaron taxones con abundancias y biomasas mayores 
...
restricciones ambientales o biológicas para que ello suceda. 

Las variaciones en la biomasa media no reflejaron un efecto vinculado con los sistemas de uso del suelo,
...
disminuían la respiración de los heterótrofos, el hecho de que no
...
una pirámide de biomasa, en el cuál los organismos detritívoros forman la base con los mayores valores, siguen los microfitófagos, omnívoros y depredadores, que con valores de biomasas próximos, que conforman el nivel intermedio de la pirámide y finalmente los herbívoros con la menor biomasa. 
Esta pirámide ajusta a lo esperado para el sistema detritívoro 
del ecosistema edáfico en el cuál los recursos tróficos bases son el tejido vegetal en proceso de fragmentación y descomposición, la materia orgánica del suelo y la microbiota saprótrofa [@lavelle2006; @lavelle2003]. 
Por su parte, los microartrópodos omnívoros y detritívoros mostraron
incrementos en la biomasa media en sistemas antropizados, tal vez, mediados 
por cambios en la disponibilidad y distribución de recursos, debidas al enriquecimiento en nutrientes en el suelo, sean estos por la fertilización, por la mineralización de la materia orgánica del suelo u otras fuentes de nutrientes como las excretas del ganado. El enriquecimiento de nutrientes en el suelo se ha relacionado con el aumento del flujo de energía a través del canal de los bacterívoros en la red trófica edáfica [@kardol2016; @potapov2019; @zhou2022]. Esta respuesta ocurre a través 
del incremento en la biomasas de bacterias, por lo tanto,
mayor disponibilidad de recursos para sus consumidores.

Al evaluar las pendientes del espectro de las comunidades edaficas no se observaron diferencias debidas al uso del suelo. 
...
Sin embargo, esta falta de evidencia de un efecto directo podría deberse a combinaciones de factores que enmascaran estas diferencias. A pesar de haber utilizado regresiones de cuantiles, diseñadas específicamente para estos casos, sería recomendable verificar los resultados con más estudios para confirmar esta conclusión.

Al analizar los espectros por gremios, la pendiente de los omnívoros edáficos 
fue positiva indicando, la presencia de taxones de mayor peso con 
una densidad importante en relación a los omnívoros de menor tamaño, 
lo que sugiere que los omnívoros de mayor tamaño son competitivamente más exitosos.
Este fenómeno podría estar mediado por las características ambientales y
por la disponibilidad de recursos para el gremio.
Sin embargo, en comparación con los demás gremios tróficos 
el rango de pesos corporales en el que se distribuyen estos omnívoros es estrecho, 
por lo tanto al no observar omnívoros de gran peso corporal no se 
...
comunidades resilientes ante los disturbios producidos por las prácticas de manejo. 
Sin embargo, los gremios tróficos si responden a las prácticas de manejo mostrando
...
<!--
Probablemente haya factores que agregan variabiliad y que deberian ser tomados en cuenta para futuros analisis, cuales serian estos factores?, inclusion explicita de variables ambientales por ej, fosforo,  nitrogeno, materia organica, cuales? Hay una diferencia fundamental entre el espectro por gremio y por la comunidad, en la comunidad tenemos diferentes niveles tróficos que imponen la restricción del flujo de energía. En los gremios solamente tenemos competencia y/o nicho.
-->
...
# La estructura topologica, los flujos de energía y la estabilidad de las redes tróficas de la fauna edáfica en suelos con distinta intensidad de uso
...
Las comunidades edáficas están influenciadas por **factores de largo plazo** tales como el clima, las características edáficas regionales y locales, la disponibilidad de recursos para los organismos que en él habitan, las influencias biogeográficas sobre las comunidades y por **factores de corto plazo** como las perturbaciones antrópicas [@kardol2016] por ejemplo aquellas que ocurren debidas al manejo del suelo con fines agropecuarios, por lo que resulta de particular interés describir la respuesta de la estructura de las redes ante los distintos tipos de disturbios y su relación con el funcionamiento del ecosistema [@sabatte2021].

Como la estructura de las redes ecológicas condiciona el funcionamiento intrínseco de un ecosistema [@labrador2008; @martin-lopez2007], la complejidad del entramado de la red trófica edáfica es un factor clave en la estabilidad de los procesos del suelo [@wardle1995; @sabatte2021]. Si bien el concepto de estabilidad en los sistemas ecológicos presenta múltiples dimensiones, puede entenderse como la capacidad del sistema edáfico para, después de una perturbación, mantener sus funciones dentro de un régimen de procesos que conserva el equilibrio del sistema [@landi2018]. Esta capacidad depende de la estructura de las comunidades, sus interacciones, y los flujos de materia y energía que atraviesan el ecosistema.

En el ecosistema del suelo los organismos pueden agruparse en grupos funcionales [@martin-lopez2007], con hábitos tróficos generalistas y que ocupan diferentes microhábitats configurados a través de la red de poros [@digel2014]. Estos grupos funcionales proporcionan una mayor capacidad de respuesta ante perturbaciones, asegurando el mantenimiento de la estructura, el funcionamiento y los mecanismos de autorregulación [@martin-lopez2007; @delmas2019; @pimm1991; @sole2001]. Sin embargo, la desaparición de especies puede desencadenar extinciones secundarias, fragmentación de la red [@sole2001] o reducciones en el flujo de energía, afectando la dinámica de la descomposición de la materia orgánica, el ciclo de nutrientes, el control de poblaciones, y la formación de estructuras biogénicas. Estos efectos pueden estar relacionados con la intensidad de las perturbaciones, como el uso del suelo [@delmas2019; @maggiotto2019].


Digel et al. [-@digel2014] y Maggioto et al. [-@maggiotto2019] utilizaron el análisis de las redes tróficas para estudiar la estructura y la topología de las redes tróficas detritívoras. Digel et al. [-@digel2014] hipotetizaron que las redes de los suelos serían estructuralmente diferentes a las redes de otros sistemas ecológicos como por ej. aquellas que ocurren por 
sobre el suelo, sustrato de arroyos o de sistemas marinos, y también aseguraban que las redes tróficas de los suelos de bosques serían diferentes de las que ocurren en suelos bajo sistemas productivos. Estos autores comprobaron la primera hipótesis pero no hallaron diferencias consistentes con su segunda hipótesis. Maggioto et al. [-@maggiotto2019] sugirieron que la estructura de las redes tróficas edáficas cambiarían debido a cambios en la composición de la hojarasca que forma la base energética de las redes tróficas detritívoras pero encontraron que la respuesta de estas redes tróficas fue resistente a los cambios en la estructura de la red. En ambos casos el análisis de la estructura de las redes fue realizado comparando diferentes comunidades y manejos, hallando características particulares para cada comunidad y coinciden en que la estructura general de las redes no varía considerablemente según el uso, aunque en estos estudios no realizaron análisis sobre los flujos de energía o cálculo de métricas de estabilidad de las redes tróficas.

Mediante las redes tróficas es posible modelar los flujos de energía para cada interacción, asumiendo que el sistema se encuentra en equilibrio. A partir de los flujos 
...
Estas representan la intensidad 
...
Estudiar las redes tróficas de la fauna de estos suelos permite comprender
...
Por ello se plantea para este capítulo, 
la hipótesis que las redes tróficas de la fauna edáfica en
...
y en los canales de energía. También se modificarán las fuerzas de interacciones 
...
bajo diferentes intensidades en el uso.


## Metodología

Se muestrearon comunidades de la fauna del suelo, provenientes de dos conjuntos de datos:

1.  Fauna edáfica en el partido de Luján, incluyendo nemátodos, mesofauna y macrofauna.
2.  Fauna edáfica en los partidos de Chivilcoy - Navarro, incluyendo microartrópodos y lombrices.
...
De esta manera, se contó con un gradiente de intensidad de uso, desde sistemas de referencia sin uso, hasta sistemas con uso agrícola intensivo, que permitió analizar el efecto de la perturbación sobre la estructura y estabilidad de las redes tróficas de la edafofauna. Más detalles de las zonas de estudio y métodos de muestreo fueron presentados en el capítulo 3.
...
Las biomasas medias de los nodos de bacterias, hongos y "protozoos", se aproximó
a partir de la respiración de los heterótrofos (Capítulo 3. Tabla 3.4). Esto se hizo
...
### Representación de las redes tróficas
...
### Flujos de energía en las redes tróficas de la fauna edáfica
...
entre el pastizal y el sistema agrícola fue mayor alrededor del 0,69%.
Los depredadores contribuyeron menos a la zoofagia que los omnívoros en
...
la contribución se aproximó a una relación 1:1.
...
se muestran mil iteraciones del máximo autovalor de la matriz Jacobiana obtenidas a partir del algoritmo del índice *Cuasi-Signo (QSS)* [@allesina2008] expresado en logaritmo natural. En el eje vertical se muestran los valores de frecuencia. Como líneas verticales se dibujan, el promedio en color amarillo, la mediana en color rojo y los cuantiles primero y tercero en celeste y scomo líneas más finas.
\vspace{0.7cm}

El promedio e intervalo de confianza del 95% de la parte real del máximo autovalor
(λ del QSS) en los suelos de la comunidad de la reserva (intensidad nula) fue de 0,445 
(0,419 - 0,472)<!-- `r exp(Q_med_R)`-->, en el sistema del pastizal (intensidad leve) fue de 0,373 
(0,349 - 0,398)<!--r exp(Q_med_P)`--> y el sistema agrícola (intensidad alta) fue de 0,334
(0,31 - 0,361) <!--`r exp(Q_med_L)`-->.


Teóricamente, las redes tróficas con el índice QSS más cercano a cero 
indican que las comunidades requieren de una menor autoregulación
para llegar a la situación de estabilidad local. 
Estos datos nos muestran para las tres intensidades de uso
valores cercanos a cero. Sin embargo, en los sistemas antropizados con intervalos de 
confianza superpuestos, los valores 
del λ del índice *Quasi-Sing* estuvieron más cercanos a cero indicando, por lo tanto, 
...
Se han construido las redes tróficas de la fauna edáfica en 
suelos de la Pampa Ondulada sometidos a diferentes intensidades de uso.
Estas al ser graficadas con la participación de cada uno 
...
poblacional y espacial de la microflora y por tanto 
la dinámica en el ciclo de los nutrientes [@coleman2004].
Para los niveles tróficos superiores, la posición de los nodos 
en la red trófica se observa difusa debido 
...
mayor tamaño a medida que aumenta el nivel trófico. Estas 
estructuran múltiples canales de energía donde la fauna edáfica 
...
con el nivel de detalle utilizado para construir las redes [@bersier2002].
...
Sin embargo, estas redes mostaron una mayor amplitud en la dieta y un mayor número 
...
En Chivilcoy - Navarro las redes tróficas en suelos antropizados
fueron más complejas y esto podría estar relacionado tanto con 
...
se alteran la dinámica de los nutrientes. En Luján, las redes en 
los suelos del pastizal 
...
la primera es, al asumir el balance energético el no incluir
...
patrón se alinea con la composición de las redes tróficas parciales, dominadas 
principalmente por 
microartrópodos edáficos que se alimentan mayoritariamente de hongos y bacterias. 

La zoofagia en las redes tróficas edáficas aquí modeladas tuvo
...
a través de verdaderos depredadores. A diferencia con lo observado en el canal de la 
detritivoría, no haber considerado algunos de los componentes no influyó
en la respuesta, sino que la misma fue diferente para cada localidad.
...
se mantuvo en valores próximos en las redes tróficas en Chivilcoy - Navarro,
pero varió consistentemente y como lo esperado en Luján,
donde el suelo con alta intensidad de uso procesó los menores flujos de energía.
...
estuvo más cerca del valor cero indicando la necesidad de menor autoregulación
para encontrarse en equilibrio estable.
Esto posiblemente se relacione con comunidades adaptadas a las prácticas de manejo 
...
mostró un valor de estabilidad ligeramente más lejana que sus contrapartes
...
Aquí los valores estimados fueron próximos a cero, 
por lo que las comunidades edáficas 
requieren de cierta autoregulación para 
alcanzar la estabilidad local [@deCastro2021; @allesina2008; @pimm1991] 
pero con distribuciones del índice del QSS diferentes, lo que sugiere que
los tres sistemas están en equilibrio con su propio régimen de perturbación.
Además, en suelos sin uso la necesidad de autoregulación es mayor
lo cuál es consistente con lo esperado para redes tróficas sin perturbaciones [@barabas2017],
ya que en los sistemas naturales se requerirán de los mecanismos de autoregulación para 
llegar al equilibrio estable.
\footnote{Autorregulación: es cuando el aumento de la abundancia de una especie disminuye su tasa de crecimiento per cápita. Entre las fuentes figuran las interferencias intraespecíficas, el canibalismo, la separación temporal entre los consumidores y sus recursos, la heterogeneidad espacial y las respuestas funcionales no lineales que acoplan a los depredadores con sus presas} 
En contraposición, en los suelos con alta intensidad de uso 
la necesidad de autoregulación es menor, ya que, en estos sistemas los disturbios 
más que los mecanismos internos regulan las poblaciones en la red trófica.
...
aunque la capacidad de mantener las funciones ecosistémicas 
podría verse afectada por la alteración en los flujos de energía [@de2012].
...
La humanidad aprovecha diferentes bienes y servicios provistos por los 
ecosistemas terrestres que dependen del funcionamiento del ecosistema edáfico.
La matriz del suelo es el hábitat de una enorme biodiversidad
cuyos procesos e interacciones ocurren simultáneamente e
influyen de manera jerárquica, a diferentes escalas espaciales 
y temporales, sobre las funciones ecosistémicas [@lavelle2012;@creamer2022].
Entender la complejidad de los sistemas ecológicos es una cuestión clave 
para mantener las características que aseguren y 
aumenten los beneficios ecosistémicos. Estudiar las redes 
de interacciones permite diagramar y modelar
las relaciones de interés entre los componentes del sistema. 
Las redes tróficas, son las redes ecológicas más estudiadas, 
éstas integran la diversidad de las comunidades ecológicas, 
las interacciones interespecíficas, las interacciones con el ambiente, 
la redundancia funcional, la multiplicidad de canales de materia y energía 
y la dinámica de los sistemas. 

La biodiversidad del suelo incluye organismos de la microbiota, de 
la fauna y a las plantas [@lavelle2003]. Estos intervienen en funciones 
ecosistémicas como el ciclo de los nutrientes, la regulación del ciclo del 
agua y su purificación, la regulación del ciclo del carbono y del clima 
y la regulación de poblaciones, plagas y enfermedades [@creamer2022]. 
De estas funciones dependen los servicios ecosistémicos de provisión, 
regulación y mantenimiento
que en términos monetarios, a nivel global, representa trillones 
de dólares anuales [@fonte2023; @coleman2004]. Específicamente, 
en la Pampa Ondulada 
debido al clima templado y la fertilidad edáfica, los suelos son destinados 
casi exclusivamente a la producción agropecuaria y por ello
son el principal generador de divisas de la Nación [@morello2000; @alvarez2006]. 

Las relaciones de alimentación en la fauna edáfica se vinculan con
importantes funciones ecosistémicas ligadas al ciclo del carbono, 
de los nutrientes y el agua, a la formación del suelo
y al control de las poblaciones [@briones2014].
Los disturbios generados por la actividad productiva, por la modificación
de las comunidades vegetales originales y la modificación de las 
características físicas y químicas de la matriz del suelo [@Bloor2021;@Smith2016],
afectan al hábitat y a la disponibilidad de 
recursos, ante lo cuál
la comunidad de la fauna edáfica responde con cambios en las poblaciones o
con cambios en los flujos de materia y energía [@phillips2024;@Chiappero2024].
Por ello el objetivo de esta tesis 
fue construir y modelar las redes de interacciones 
tróficas de la fauna edáfica en suelos bajo diferentes intensidades de uso 
en la Pampa Ondulada y, a través de sus métricas, evaluar su efecto sobre la 
estructura y funcionalidad de las mismas. Como las redes tróficas 
integran diferentes atributos de la comunidad, 
fue posible ademas explorar los efectos sobre la diversidad, 
el espectro de tamaños, la estructura de las redes, los flujos de energía
y la estabilidad de las redes. 

<!--
En este contexto, el objetivo de la tesis es construir las redes tróficas de la fauna edáfica que ocurren en
suelos bajo diferentes intensidades de uso en la Pampa Ondulada Argentina, para analizar las
características funcionales de las comunidades edáficas y su estabilidad como aproximación para la
provisión de herramientas que permitan evaluar el estado de conservación del suelo.
-->

No es posible determinar todas las interacciones 
de alimentación en el ecosistema edáfico, ya que el mismo 
es un entorno críptico y 
la fauna que hospeda es en su mayoría microscópica y su taxonomía dista de estar resuelta.
Por ello, como primer eje para la construcción de la red fue 
necesario explorar la ecología trófica de estos organismos, para establecer 
las interacciones de alimentación potenciales en la misma. 
La búsqueda sobre este aspecto implicó la descripción detallada 
de los métodos utilizados por la comunidad científica para determinar 
las interacciones de alimentación y la clasificación de trece recursos tróficos 
utilizados por la fauna edáfica. Una revisión global sobre la biología trófica de los
ácaros y colémblos, los microartrópodos edáficos más abundantes y con 
una amplia diversidad trófica, determinó que
alrededor del mundo el conocimiento es escaso y se limita sobre todo 
a los grupos más numerosos o conspicuos del suelo y principalmente en suelos europeos.
A pesar de la poca información disponible globalmente sobre los hábitos tróficos de los 
organismos del suelo -idea que refuerza la necesidad de conocer en profundidad la biología de 
estos organismos a nivel regional- es posible aproximar el uso de los recursos tróficos por 
parte de la fauna edáfica mediante el estudio de la evidencia empírica de los hábitos tróficos 
de categorías taxonómicas de familias, géneros o especies de modo que se puedan estimar las 
dietas de grupos taxonómicos superiores [@Potapov2016a;@Potapov2020]. 
Ante esta evidencia, la ecología trófica 
de los demás taxones de la fauna fueron resumidos basados en el conocimiento 
disponible y utilizados como aproximación de la dieta potencial [@Potapov2022].
Además, fue posible determinar gremios tróficos para agrupar 
los diferentes taxones de la fauna edáfica en función del uso 
de los recursos tróficos y cuyos procesos tróficos a la vez se relacionan 
con funciones ecosistémicas.

Las comunidades son afectadas por factores de largo y corto plazo,
tales como el clima, el tipo del suelo, las dinámicas biogeográficas, los disturbios 
antropogénicos, etc. y estos factores condicionan la estructura de las 
comunidades y por lo tanto a las redes tróficas. 
Por ello, en el capítulo 3 se exploraron las características ambientales
y la diversidad en las comunidades de la fauna edáfica en suelos
bajo diferente intensidades de uso. Se encontró que la intensidad 
de uso modifica el hábitat para las especies:
en sitios sin perturbar presentaron una mayor actividad heterotrófica asociados con
el contenido de materia orgánica y valores de pH más altos, 
por su parte, los sitios con una alta frecuencia de disturbio
tuvieron valores de acidez más altos acompañados de concentraciones mayores 
de nitrógeno y fósforo. Las comunidades de la fauna edáfica fueron diferentes 
entre usos del suelo, indicando la respuesta de estas a las condiciones del hábitat.
Sin embargo, contrario a lo esperado, el valor de diversidad utilizado se mantuvo
similar tanto en toda la comunidad como entre sus componentes. Dado el
nivel taxonómico utilizado en el análisis es necesario explorar en mayor
profundidad esta característica para dilucidar si esto es un mecanismo 
que refleja la redundancia funcional, es decir, un amplio número de taxones que realizan 
procesos similares en la red trófica [@walker1992;@bardgett2002]
o la resiliencia, es decir, el mantenimiento
de las poblaciones en régimen de funcionamiento característico de la comunidad [@maggiotto2019;@kardol2016;@Pimm1982].

Todos los organismos responden a las perturbaciones ambientales y a los 
cambios que ocurren en las condiciones del nicho.
Específicamente, la fauna adaptada a la red de poros del suelo
responde a los disturbios ocasionados por la actividad antrópica 
en los primeros centímetros del suelo [@phillips2024; @Yin2020].
Las respuestas se traducen, 
a nivel del organismo, como cambios 
en los rasgos funcionales, como por ejemplo el tamaño corporal, y
como cambios en la estructura poblacional de los taxones en la comunidad,
por lo tanto, de la biomasa [@sechi2017].
El modelo del espectro de tamaños utilizado en esta tesis,
integra las variaciones poblacionales y las variaciones 
en los pesos corporales, los cambios en las pendientes del modelo
reflejan la respuesta a los factores considerados [@petchey2010; @white2007; @turnbull2014].
Además, junto con la biomasa media, que mide la cantidad de materia orgánica 
retenida, estas variables se relacionan con el metabolismo y el flujo de energía 
en la red [@gauzens2019]. 

En el capítulo 4, se realizó
la descripción detallada 
de la distribución de los pesos corporales, los pesos corporales promedios, las 
densidades y las biomasas medias de los taxones hallados en los diferentes 
usos del suelo. Esta información es requisito para calcular los flujos de energía 
que recorren la red trófica en los suelos bajo estudio. Se observaron respuestas
que sugieren adaptaciones de diferentes taxones a diferentes usos del suelo. 
Además, para
integrar la información recopilada, y ajustándose a lo comentado en el 
párrafo anterior, los objetivos 
fueron conocer como varían la biomasa media y 
el espectro de tamaños de la fauna del suelo 
sometidos a diferentes sistemas de uso. <!--Se esperaba que tanto la biomasa media 
como el espectro de tamaños indiquen diferencias que reflejen el impacto 
que tiene la intensidad de uso del suelo. Sin embargo, analizando toda la comunidad,
no fue posible atribuir cambios, ni en las biomasas medias 
ni en el espectro de tamaños, como dirigidas por los usos del suelo.-->
Fue posible determinar variaciones en la pendiente del espectro de tamaños
a través de algunos gremios tróficos y estos reflejaron
el efecto negativo de la intensidad del uso del suelo, en suelos de Luján,
como el efecto positivo en suelos bajo manejo, en suelos de Chivilcoy-Navarro.
Estos resultados nos dicen que el uso del espectro de tamaño puede 
ser una herramienta útil para estudiar el impacto de los disturbios
sobre la fauna del suelo pero considerando 
que existen grupos que son más sensibles y que las respuestas están
reflejando la disponibilidad de recursos. Por último, al considerar toda la comunidad, 
no haber hallado respuestas vinculadas con el uso del suelo 
sugiere resiliencia de las comunidades de la edafofauna,
conservando la cantidad de materia y energía que es capaz de procesar, 
regular y retener en el sistema detritívoro del suelo.

Los procesos tróficos como 
la detritivoría, la microfitofagia, la zoofagia, la humifagia y la herbivoría 
contribuyen a las funciones ecosistémicas relacionadas con el ciclo del carbono,
de los nutrientes y del agua, con la generación de la estructura del suelo y con 
la regulación de poblaciones. La capacidad del sistema edáfico para, 
después de una perturbación, mantener sus funciones dentro de un régimen de procesos que conserva el equilibrio del sistema [@landi2018]
estará condicionada a la estructura, complejidad y los flujos de materia y energía en la red trófica de la fauna edáfica [@wardle1995; @sabatte2021]. En el capítulo 5,
se modelaron las redes tróficas de la fauna edáfica que habitaban suelos bajo diferentes 
intensidades de uso y se observaron tres aspectos claves 
para interpretar el funcionamiento de estos sistemas: la topología, los flujos de energía y
la estabilidad de las redes. La hipótesis fue que la estructura de 
las redes iba a ser diferente entre los diferentes sistemas pero a la vez
los suelos con alta intensidad de uso mostrarían redes menos complejas,
con los menores flujos de energía y el valor de estabilidad también se vería 
afectado por el uso intensivo del suelo indicando estar 
alejado de la situación de equilibrio. 

Se encontró que 
las redes tróficas tuvieron tamaños y conectividades diferentes 
para cada sistema de manejo. En este punto, las diferencias en la 
estructura de la comunidad observadas en el capítulo tres se complementan 
con las interacciones tróficas. Contrario a lo esperado no se observaron grandes
diferencias en los índices topológicos calculados, sin embargo, 
la complejidad fue menor en sistemas sin uso del suelo, 
pero con más especies topes y 
una mayor amplitud en la dieta, por lo tanto relacionándose con
una mayor presión de 
depredación y una mayor robustez ante el impacto de los disturbios [@thompson2018;@fath2004;@polis1996]. Además, los índices topológicos
que resumen las características de la estructura trófica se mantuvieron similares
al considerar redes tróficas parciales y completas, lo cuál está relacionado con 
la reticularidad, es decir, redes incluidas en las redes [@wolkovich2016]. 

Los flujos de la energía fueron similares 
en los suelos de Chivilcoy - Navarro, pero difirieron en suelos de Luján. 
Los suelos con alta intensidad de uso computaron los menores flujos de energía 
y esto se relaciona con una menor contribución a los procesos tróficos [@potapov2022], 
lo cuál podría afectar a la dinámica de las funciones ecosistémicas 
mediada por la fauna del suelo. A través de los canales de energía se observó que,
los componentes considerados en el análisis pueden reposicionar la 
importancia del canal de la energía con relación al flujo total, 
específicamente, al no considerar la macrofauna 
la importancia de la detritivoría varió. También se observó que la zoofagia tiende a 
ser llevada por los omnívoros más que por los verdaderos 
depredadores aunque con una relación cercana al uno a uno, en contraste,
en el suelo sin uso en Luján la contribución de los depredadores fue mínima. 
De estos últimos hallazgos se puede deducir que, para realizar 
estudios sobre diversos suelos es necesario considerar todos 
los componentes posibles de la fauna edáfica o 
entender las posibles implicancias de obviarlos,
además, resulta necesario explorar más a fondo el aporte que tienen los verdaderos depredadores 
y los omnívoros en la regulación de poblaciones lo que podría resultar 
fundamental para el control de plagas y enfermedades [@sanchez2007].

El índice de estabilidad utilizado para comparar las redes tróficas completas
de comunidades de la fauna edáfica sometidas a diferentes intensidades 
de uso resultó similar y próximos al valor cero.
Los datos indicaron que los suelos con alta y leve intensidad en el
uso del suelo requieren de una 
menor autorregulación que el suelo sin uso. Esta respuesta podría estar 
reflejando el efecto que los disturbios tienen al contribuir en 
la regulación de estos sistemas ecológicos [@deCastro2021,@allesina2008; @pimm1991].
Sin embargo, el valor próximo a cero, nos dice que los
tres sistemas están en equilibrio con su propio régimen de perturbación.
Esto podría tratarse de diferentes estados estables alternativos [@beisner2003].


En resumen, se evaluaron las redes tróficas de la 
fauna edáfica en suelos de la Pampa Ondulada
que se encontraban bajo diferentes intensidades de uso. Los suelos
fueron diferentes por sus características edáficas y en cada uno de ellos
la estructura de las comunidades de la fauna del suelo reflejaron
las adaptaciones a dichos suelos. Aparentemente, las comunidades analizadas
resultaron resilientes, ya que mantuvieron los valores de la diversidad, 
de las biomasas, de la relación del espectro de tamaños y de las métricas topológicas 
en valores próximos entre sí. Estas respuestas, 
podrían estar vinculadas con la redundancia funcional característica de la fauna edáfica [@bardgett2002], lo que permite a las comunidades mantener su estructura funcional.
Sin embargo, en los suelos con alta intensidad de uso 
la necesidad de una menor autoregulación mediada por
el efecto de los disturbios sobre las poblaciones 
y además la menor cantidad de energía procesada por la red trófica,
podrían relacionarse con efectos que afecten a los procesos tróficos
lo cuál influiría sobre el funcionamiento ecosistémico mediado por la fauna edáfica
al modificar la capacidad de procesamiento de materia y energía en la red trófica [@de2012]. 

Cabe destacar que centrarse únicamente en atributos 
como la diversidad o la biomasa en las comunidades de la fauna edáfica, 
podría ocultar los efectos de los disturbios debido a la aparente resiliencia
detectada en las comunidades estudiadas. 
Los disturbios ejercidos por las prácticas antrópicas 
no implican respuestas lineales en las comunidades del suelo.
Por ejemplo, las biomasas de las comunidades bajo diferentes intensidades de uso
se mantuvieron similares pero los flujos de energía en la red trófica fueron afectados.
Considerando que la resiliencia en las comunidades podría mantener cierto régimen de 
funcionamiento con aparente estabilidad, no es posible descartar que puedan darse cambios que 
deriven en eventos catastróficos [@scheffer2009]. De ser así, esto implicaría cambios drásticos en las comunidades y sus interacciones, afectando directamente a la conservación de las propiedades ecosistémicas que derivarían en 
modificaciones en el funcionamiento ecosistémico del suelo [@suding2004].
El análisis de los parámetros topológicos y de los flujos 
de energía a través de las redes tróficas explorado en esta tesis, 
ofrece información detallada sobre la estructura y el funcionamiento de las comunidades,
que permiten una caracterización integral de los impactos derivados
de las diferentes prácticas de manejo. 
De esta manera, los resultados obtenidos en esta tesis sientan 
bases metodológicas novedosas para el desarrollo de investigaciones 
sobre la funcionalidad mediada por la fauna edáfica.
A partir de ella deberán analizarse las implicancias vinculadas
con la conservación de los procesos ecosistémicos y su influencia
sobre la conservación de la calidad\footnote{La utilidad del suelo para un propósito específico en una escala amplia de tiempo. En particular objetivos productivos}
y la salud del suelo \footnote{La capacidad del suelo para funcionar
como un ecosistema vital. Este integra todos
los componentes del mismo y vá más allá del aprovechamiento económico}.



<!-- Cabe destacar, que en las comunidades de la fauna edáfica, centrarse únicamente en parámetros como la diversidad o la biomasa podría ocultar los efectos de los disturbios debido a la resiliencia inherente de estas comunidades. Como los disturbios ejercidos por las 
prácticas antrópicas no implican respuestas lineales en las comunidades del suelo,
por ejemplo y como lo visto aquí, las biomasas de toda la comunidad se mantiene similares
pero sus flujos de energía en la red trófica son afectados, 
y considerando que la resiliencia en las
comunidades podría mantener cierto régimen de funcionamiento 
bajo determinadas condiciones, podría suceder que se diesen cambios que 
deriven en eventos catastróficos,
lo que implicarían cambiós drásticos en las comunidades y sus interacciones, 
afectando directamente a la conservación de las propiedades ecosistémicas 
que derivarían en modificaciones en el funcionamiento ecsistémico del suelo.
En cambio, el análisis de los parámetros topológicos y los flujos de energía a través de las redes tróficas ofrece más información sobre el comportamiento y el funcionamiento de
una pieza clave en estos ecosistemas que permiten
una evaluación precisa de los impactos derivados 
de las diferentes prácticas de manejo.
Finalmente, observar comunidades adaptadas a 
los diferentes sistemas de manejo con una estructura robusta
que mantiene propiedades de la comunidad en ciertos regímenes de funcionamiento,
no permitió ver diferencias marcadas que hayan sido mediadas por el uso del suelo,
esto podría influir en 
excepto por los flujos de energía y algunas respuestas específicas en el espectro de tamaños
mediadas por diferentes gremios tróficos por lo cuál estas deben se puesta en foco 
para dilucidar los efectos que el manejo del suelo tiene sobre el funcionamiento 
del ecosistema. 
Por otra parte, no se puede determinar las características de los suelos 
originales con pastizales prístinos en la Pampa Ondulada debidas a la
conversión de estos con una larga historia de uso. Por lo cuál, 
estamos observando comunidades adaptadas a cierto régimen de funcionamiento, 
que hipotéticamente, podrían estar dirigiéndose hacia nuevos estados estables alejados 
de las condiciones originales o que ya se encuentran funcionando en dicho estado estable.
-->
...
### Descripción sobre el Material Suplementario
...
Lote Agrícola: Con una superficie de 8 hectáreas, muestra una intensa actividad agrícola y ganadera desde 1984 hasta 2022. Durante este período, se realizaron múltiples labores de preparación del suelo, tales como arado, rastra, cincel y disco, a menudo combinadas con fertilización y pulverización con herbicidas. Se sembraron diversos cultivos, incluyendo moha, alfalfa, trébol blanco, trébol rojo, festuca, maíz, avena y raigrás, junto con algunos ciclos de pastoreo intensivo.

Desde 1984, las rotaciones y cultivos fueron variadas, con un enfoque en pasturas, maíz para silo, y avena, con la inclusión de fertilizantes como FDA, urea y SPT para mejorar la productividad. A partir de 1999, se observa la implementación de técnicas de labranza reducida y un manejo más enfocado en cultivos forrajeros como raigrás y alfalfa. Durante los últimos años, se continuó con la fertilización y el uso de herbicidas para controlar malezas y optimizar los rendimientos. La rotación de cultivos y la fertilización con urea y SPT fueron constantes a lo largo de los últimos años, buscando una adecuada productividad y conservación del suelo.


**Suelos Chivilcoy-Navarro**


-   Pastizales naturalizados: pastizales abandonados sin influencia antrópica
directa significativa por al menos 50 años. Son campos cuya vegetación
predominante es Festuca pratensis, Stipa spp, Cardo negro (Cirsium vulgare) y
duraznillo (Solanum laucophylumm).

-   Sistema mixto agrícola-ganadero: con 25 años bajo pastoreo continuo con alta carga animal y
dos años antes de comenzar este estudio (2007), rotó a la producción de pasturas
(fardos de avena, maíz y sorgo) para feedlot. El cambio en el sistema de producción
involucró el uso de equipamiento (subsolador) el cual trabaja a mayor profundidad
en el perfil del suelo, con el objetivo de descompactar el mismo. Se utiliza siembra
directa, ya que la zona no permite otro método por el escaso drenaje. Se aplican
herbicidas (glifosato, dicamba para hoja ancha y 2,4 D) y fertilizantes (fosfato de
amonio y urea).
En estos campos se realizan prácticas de conservación, tales como el respetar
las rotaciones e incorporar los restos de cosecha al suelo. Esta incorporación aporta
materia orgánica e incide directamente sobre la estructura del suelo y su estabilidad e
indirectamente a través de la incorporación de alimento para la biota edáfica y así,
sobre el ciclado de nutrientes. En todos los campos, se hizo algo de movimiento de
suelos: varios canales, se diseñaron y armaron lotes, se taparon pozos de caminos de
ganado, etc. En algún momento se hicieron rollos de rastrojos, pero se decidió no
realizar más esta práctica, porque se prefiere incorporarlo para darle estructura al
suelo.


-   Sistema agrícola intensivo: bajo agricultura intensiva continúa por 50 años y bajo siembra
directa durante los 18 años anteriores al inicio de los muestreos. La principal rotación
utilizada es maíz-trigo-soja, con siembra directa, control químico de las malezas y se
caracteriza por un alto volumen de residuos de cosecha de superficie. Durante la
temporada de cultivo, se utiliza maquinaria pesada y se realizan aplicaciones de
insecticidas, herbicidas y fertilizantes. Primero se aplican herbicidas para hacer control
de malezas, luego se siembra (siembra directa), a veces se realiza otra aplicación de
herbicida y/o insecticida según necesidad y luego se cosecha.
Se utiliza soja transgénica y maíz bt para barrenador, se realiza fertilización en línea e
inoculación, es decir, se aplica la tecnología normal para la siembra directa, buscando
los mejores rindes. La soja se fertiliza al inicio del ciclo con mezcla de fertilizantes que
contienen fósforo, nitrógeno, calcio y azufre. En soja y maíz y a veces en el trigo se
fertiliza en la siembra, y en el macollaje a veces se hace una aplicación de urea para
aporte adicional de nitrógeno.


Abajo se muestran los sitios de muestreo donde se tomaron las comunidades de la fauna edáfica trabajadas en los suelos de Chilcoy-Navarro (Amarillo) y Luján (Rojo)

![]("Figures/Ap_cap3.png"){heigth=1000 width=830}
...
![]("Figures/Ap_cap4.png"){heigth=1000 width=830}


Protocolo para obtener las mediciones morfométricas de la fauna edáfica.
Una vez obtenida la imagen con escala de referencia, se carga la misma al
la aplicación ImageJ, se ajusta la escala, se mide el segmento y se exporta 
el valor en hojas de datos.
