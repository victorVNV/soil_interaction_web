...
tabla5.1%>%kbl() %>%kable_classic(full_width = F, html_font = "Times New Roman")
...
tabla5.2%>%kbl() %>%kable_classic(full_width = F, html_font = "Times New Roman")
```
