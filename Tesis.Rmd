...
la importancia de la detritivoría cambió. También se observó que la zoofagia tiende a 
...
La índice de estabilidad utilizado para comparar las redes tróficas completas
...
de las biomasas, de la relación del espectro de tamaños, de las métricas topológicas 
y del índice de estabilidad en valores próximos entre sí. Estas respuestas, 
...
Sin embargo, el funcionamiento ecosistémico en 
suelos con alta intensidad de uso podría estar en riesgo al afectarse
fuertemente los procesos tróficos y por lo tanto la
capacidad de procesamiento de materia y energía. 

Los resultados indican comunidades adaptadas 
tanto a diferentes coberturas vegetales como a 
diferente intensidad de disturbio antrópico. Estas comunidades 
configuran probablemente 
diferentes estados estables alternativos [@beisner2003],
con una estructura funcional robusta cuyos procesos tróficos,
ante la alteración de los flujos de energía,
indican la potencial pérdida en la capacidad de mantener 
las funciones ecosistémicas [@de2012].
...
Cabe destacar que centrarse únicamente en parámetros 
...
detectada en las comunidades estudiadas. Los disturbios ejercidos 
por las prácticas antrópicas no implican respuestas lineales en las comunidades del suelo.
...
deriven en eventos catastróficos  [@scheffer2009]. De ser así, esto implicaría cambiós drásticos en las comunidades y sus interacciones, afectando directamente a la conservación de las propiedades ecosistémicas que derivarían en 
...
sobre la conservación en la calidad y la salud del suelo.
