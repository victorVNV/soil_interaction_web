...
se muestran mil iteraciones del máximo autovalor de la matriz Jacobiana obtenidas a partir del algoritmo del índice *Cuasi-Signo (QSS)* [@allesina2008] expresado en logaritmo natural. Eje vertical se muestran los valores de frecuencia. Como líneas verticales se dibujan, el promedio en color amarillo, la mediana en color rojo y los cuantiles primero y tercero en celeste y scomo líneas más finas.
\vspace{1cm}
...
Las redes tróficas, son las redes ecológicas más estudiadas, estas   
integran la diversidad de las comunidades ecológicas, 
...
A través del suelo no es posible determinar todas las interacciones 
de alimentación, dado que el suelo es un entorno críptico y 
la fauna que hospeda es en su mayoría microscópica.
Por ello, como primer eje para la construcción de la red trófica fue 
necesario explorar la ecología trófica de estos organismos, para establecer 
las interacciones de alimentación potenciales en la red trófica. 
...
Por ello, en el capítulo 3 se exploró sobre las características ambientales
y sobre la diversidad en las comunidades de la fauna edáfica en suelos
...
Específicamente, la fauna del suelo adaptada a la red de poros del suelo
...
El modelo del espectro de tamaños integra las variaciones poblacionales y las variaciones 
...
La red trófica de la fauna edáfica cumple un rol clave en el 
funcionamiento ecosistémico del suelo. Los procesos tróficos como 
...
la complejidad fue menor en sistemas sin uso del suelo, pero 
con más especies topes y 
...
entender las posibles implicancias de obviarlos, además, 
resulta necesario explorar más a fondo  
el aporte que tienen los verdaderos depredadores y los 
omnívoros en la regulación de poblaciones lo que podría resultar 
...
Cabe destacar, que en las comunidades de la fauna edáfica, centrarse únicamente en parámetros como la diversidad o la biomasa podría ocultar los efectos de los disturbios debido a la resiliencia inherente de estas comunidades. En cambio, el análisis de los parámetros topológicos y los flujos de energía a través de las redes tróficas ofrece información 
relevante y detallada sobre el comportamiento y funcionamiento de los ecosistemas, 
permitiendo una evaluación más precisa de los impactos derivados 
