...
También el fósforo se correlacionó negativamente con la respiración heterotrófica aunque representó una situación marginal (p-valor igual a $\rho$: p~valor~ = 0,1). Se observó correlación positiva entre el fośforo y el nitrógeno $\rho$ = 0,57 pero el nivel de significancia estuvo un punto por arriba de la situación marginal $\rho$: p~valor~ = 0,11.
...
( En chivilcoy Navarro ) Entonces si el aumento en la cantidad de Nitrógeno se relaciona con la disminución del pH, esta disminución del pH favorece el aumento del fósforo disponible. 
En cambio, la correlación fue positiva entre el pH y la respiración heterotrófica, por lo que la actividad biológica aumenta cuando el medio es más alcalino. Con el fósforo la correlación fue negativa lo que puede relacionarse con el hecho de que la materia orgánica humificada forma complejos con el fósforo. A medida que aumenta el contenido de MO en el suelo la concentracion de P disminuye, la relacion c/P aumenta. [@alvarez_steinbach_2009]

Sobre las diferencias con KW : 
...
en luján la amplitud en la variación del valor del fósforo puede ser debida al efecto de la fertilización, ya que como este nutriente es poco móvil lugares con mayores cantidades de fósforo reflejan puntos de fertilización con el nutriente.

En suelos de Luján, en el sistema de la reserva se observó
una mayor actividad respiratoria. En estos suelos la disponibilidad de materia orgánica susceptible a la descomposición (broza u hojarasca) se distribuye sobre la superficie con un gran volumen y es más constante a lo largo del año, en cambio en suelos agrícolas donde la actividad respiratoria fue menor la hojarasca sobre el suelo es puntual y estacional. En suelos de Luján no se encontraron diferencias entre los sistemas de uso del suelo, ni en la relación de hongos/bacterias ni en la cantidad de hojarasca en superficie.

Los ácaros sarcoptiformes mostraron una correlación con los vectores del suelo de la reserva, 
en esta situación también se hallan los macroartrópodos omnívoros y
los tardígrados. , estos animales indicando la presencia de retención y saturación de humedad en el suelo. Los colémbolos se relacionan con el sistema del pastizal.
