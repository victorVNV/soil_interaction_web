...
unlu_merg$resp.b<-round(c(0.066236559139785,0.0851612903225806,0.0946236559139785,
                    0.131588785046729,0.14803738317757,0.14803738317757,
                    0.188187372708758,0.15234215885947,0.170264765784114),4)
#agrego relación Hongo-Bacterias
unlu_merg$ratio.hb<-round(c(3.25,14.0000000000001,0.833333333333333,
                       1.375,1.83333333333333,1.16666666666667,
                       2.42857142857143,1.83333333333333,3.5),3)
...
```{r índices_clásicos,echo=FALSE,warning=FALSE}
