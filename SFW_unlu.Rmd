...
#calc_interaction_intensity(as.edgelist(L_netf))

pesoL_net <-graph_from_adjacency_matrix(matrix(dimnames = list(body_L,body_L),nrow=length(body_L),ncol=length(body_L)),mode=c("directed") )
...
edge_list_UNLu<-edge_list_UNLu[,c(2,1,4,3,6,5)]
edge_list_UNLu$dimension<-"2D"

calc_interaction_intensity(da=edge_list_UNLu,
