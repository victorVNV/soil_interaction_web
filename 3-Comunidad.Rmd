...
la estepa o pseudoestepa de gramíneas [@cabrera1973; @oyarzabal2018]. El
...
crecimiento de las raíces y tienen un buen contenido de materia orgánica [@cabrera1973]
la topografía es plana y extensa, además cuenta con importantes acuíferos
...
Urricariet y Lavado en -@urricariet1999 ya mencionaban que la Pampa Ondulada estaba siendo sometida a
...
[@orgiazzi2016], es decir la vida del suelo, ya que la diversidad
...
estructurales que conforman los procesos ecologicos de los ecosistemas terrestres [@colombo2014; @bedano2006b; @hooper2005; @brussaard2007; @barrios2007].
...
organismos que contribuyen, a diferentes escalas, a la formación del suelo [@wall1999; @barrios2007; @bardgett2002; @potapov2022; @zotero-1438; @creamer2022].

Por ello es que Socarras (-@socarras2013) menciona que conocer el número de los diferentes taxones,
...
climáticas particulares; tambíen Cruz y colaboradores (-@cruz2004) mencionan en su síntesis
...
fauna edáfica tomada en suelos del partido de Luján (Tabla 3.1) y 
fauna edáfica pertenecientes a suelos de los partidos de Chivilcoy y Navarro,
...
Los suelos de Luján fueron muestreados en el año 2022 y
...
Los suelos ubicados en los partidos de Chivilcoy y Navarro fueron muestreados por Sandler -@sandler2019,
en cada estación del año durante dos años entre 2009 y 2010, dejando un conjunto
...
que permitió al autor la medición de rasgos corporales [@velazco2023;@velazco2023a].

### Diseño de muestreo

Durante el año 2022 se llevó adelante el muestreo de suelos Argiudoles
típicos ubicados el campo experimental de la Universidad Nacional de Luján
[@sfeir1998] [imagen1_mapa].

El muestreo se llevó adelante con la intención de colectar la fauna edáfica que pasa todo
su ciclo de vida en el suelo [@momo2009; @walkwork1970], conocidos
también como **geobiontes**. Los geobiontes incluyen tres rangos de tamaño [@swift1979],
...
50 metros entre sí y separadas 10 metros de los bordes de parcelas [@moreira2012; @potapov2022a].
...
muestra compuesta fué sometida al método de flotación y tamizado [@jenkins1964; @moreira2012; @mondino2010]. 
...
conservan en formalina 4% [@moreira2012] o alcohol 96º [@potapov2022a]
hasta su posterior extracción y conteo bajo lupa binocular, e identificación en grupos
tróficos según la morfología de su aparato bucal [@momo2009; @yeates1971; @mondino2010]
...
shorting"*), hasta su posterior conteo e identificación [@potapov2022a]).
...
lombrices de tierra, arañas lobo, bichos bolita, milpies, cienpies, entre otros [@moreira2012; @potapov2022a].
...
taxonómicos [@vargas2014]. Las lombrices de tierra (Oligochaeta:
Crassiclitellata) fueron identificadas hasta especies [@reynolds1996; @satchell1983; @demichis1999] y la macrofauna restante fué separada en diferentes rangos
taxonómicos desde órdenes hasta familias [@choates1999; @claps2020; @klimaszewiski1997; @dindal1990; @zhang2011; @vargas2014]
...
[@vargas2007] Estas se desagregan en agua en relación 1:4 de suelo:agua, se agita
...
claves taxonómicas que pueden consultarse en: @krantz2009;@momo2009; @janssens; @balogh1988; @burges1967; @evans1979; @dindal1990.
...
Navarro según describe Sandler (-@sandler2019) implicó, el uso de la técnica de flotación y
...
mayor actividad de la microbiota [@pankhurst1997], se llevó adelante la técnica para estimar la 
respiración heterotófica [@frioni1999], esta consiste en homogeneizar y pesar 10 g de suelo por 
...
cuyo resultado es la aproximación del total de bacterias y hongos hallados en el suelo [@west1986; @zabala2010].
...
clorhídrico HCl 0,1 M y fenolftaleína como indicador [@frioni1999; @coleman2004].
...
antibioticos en relación con la respiración total [@zabala2010].
...
variables ambientales y los sistemas de uso bajo estudio [@legendre2012].
...
$$
  ...
  *   $p_i$ es la proporción del $i$-ésima taxón en la comunidad.
...
En ambos análisis se utilizó el coeficiente de distancia de Bray-Curtis [@legendre2012;@koleff2003].
...
[@legendre2012] esta manera permite observar en el <u>gráfico biplot</u> a los sitios
