...
cuanto a su composición química y biológica. Es así que, resulta clara la separación 
...
característica del sistema edáfico [@anderson1978], la redundancia funcional 
...
Esta diferencia se relaciona con los procesos que ocurren sobre el ambiente debidas a las prácticas de manejo.
...
La reducción de dimensiones además 
permitío ver grupos taxonómicos vinculados con ciertos sistemas El ordenamiento de También existen relaciones 

Esta diferencia se relaciona con los procesos que ocurren sobre el ambiente debidas a las prácticas de manejo.

ecosistema edáficoen el que 
los taxones ocupan 
Si se observan cambios en la composición de las comunidades siendo entre diferentes sistemas de 
manejo 




por lo que el resultado de estsistema resultes en general más resiliente.


vinculados mediante su actividad biológica a las funciones ecológicas, 
por ej. la pérdida de especies de colémbolos microfitofagos nocon los procesosque ocurren en el ecosistema del 
suelo existen múltiples taxones que caracteriza al ecosistema edáfico, esta
redundancia de taxones implica también redundancia de funciones 
y puede la resiliencia del sistema al momento de mantener 
los diferentes procesos ecologícos a la vez para diferentes funciones ecológicas claves[@anderson1978], tales como, el control de poblaciones de la microflora, la fragmentación de la hojarasca, la herbivoría, la formación de canales a través del suelo, etc.

, sin embargo, las comunidades que habitan en los diferentes sistemas de uso del suelo difieren en composición
por ello es que encontramos separaciones de las comunidades edáficas 
entre los diferentes sistemas de uso y similitudes dentro del sistemas de uso.  existen diferencias claras en la diversidad beta y se puden reconocer asociaciones entre ciertos taxones y los sistemas de uso del suelo.

<!-- 

***El índice de Shanonn separa sitios :Luján tiene mayor diversidad que Chivil+ Navarro. Estos últimos tienen más de 50 años bajo producción.
No hay diferencias en la diversdad calculada para cada uso.
NO se calcula la beta diversidad, sin embargo me suege la pregunta estan anidadas las comunidades? Luján contiene a todas los taxones de Chivil+Navarro?
Sin embargo la riqueza de taxones  y su composición varian con el uso del suelo respuesta de la intensidad del disturbio asociado a las caracteristica de la vegetación--> 
...
<!--Si bien la riqueza son similares se diferencian en la composición de especies y en sus abundancias.
Esto se puede relacionar con la dinámica y caracterización de la redes-->
