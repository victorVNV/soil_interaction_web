...
químicas. Además la fauna edáfica de estos lotes fueron fueron preservados lo que permitió al autor la medición de rasgos corporales.
...
Además de manera complementaria se estimaron, por un lado, la biomasa de la microflora y 
la proporción de procariotas y eucariotas, y por el otro, las variables edáficas químicas y
físicas.
...
agricultura convencional con labranza para la producción de forraje de alfalfa 
...
proceso que se realiza con porta y cubreobjeto bajo microscopio óptico con aumentos de
hasta 400 veces.
...
queda atrapado en los tamices de 1000 $\mu m$ a 170 $\mu m$.
...
y estimular la actividad biológica. Como blancos (controles) de la reacción se utilizaron
...
mediante análisis de varianza no paramétrico Kruskal-Wallis. Luego se procede al análisis multivariado mediante el uso de componentes principales con los valores de las
...
las comunidades, se realiza un dendograma basado en el índice de diversidad Beta de
Bray-Curtis (paper done estan los indices segun el paquete Vegan) para visualizar cuáles 
son las comunidades similes. 
Para describir las relación entre los taxones y los sitios se realizó
análisis de componentes principales transformados con log_b_x + 1. (\@.numerical_ecology)
e invertidos (en modo R) de modo de poder observar en el gráfico biplot a los sitios como 
