...
La Pampa argentina <!--imagen de la pampa--> es una amplia llanura con una extensión de más de 450 mil km^2^, de las
...
la pérdida de fertilidad debidas a las prácticas intensivas de manejo, ellos basaron sus
...
En esta sección se pretende describir las comunidades edáficas halladas en suelos
...
En ambos casos se tomaron muestras en suelos con diferentes formas de uso y se
...
durante dos años entre 2009 y 2010, dejando un conjunto
...
preservados en el laboratorio de Ecología pertenencientes al programa de Ecología Terrestre (INEDES-UNLu) lo
que permitió al autor la medición de rasgos corporales [@velazco2023;@velazco2023a] tópico que será tratado en el capítulo siguiente.
...
su ciclo de vida en el suelo [@momo2009; @wallwork1970], conocidos
...
Se eligieron 3 sitios (Tabla 3.1.) con diferentes usos del
...
Acacia *Acacia melanoxylon*.<!--Ver las imagenes de muestreo -->
...
taxonómicos desde órdenes hasta familias [@choate1999; @claps2020; @klimaszewiski1997; @dindal1990; @zhang2011; @vargas2014]
...
cuyo resultado es la aproximación del total de bacterias y hongos hallados en el suelo [@west1986; @zabala2010; @beare1990].
...
**Tabla 3.x Variables químicas de suelos Argiudoles típicos. Valores promedio y desvío estandar del pH, el porcentaje de materia orgánica (MO), el porcentaje de nitrógeno (N) y el fósforo asimilable (p.p.m.). Las letras representan diferencias significativas evaluadas mediante la prueba de Kruskall-Wallis. Los  sitios se corresponden con los sistemas de uso del suelo, en Luján: R=Reserva, P=pastizal,A=agrícola; en Chivilcoy y Navarro: N= pastizal naturalizado, G= sistema mixto agrícola ganadero, A= agrícola intensivo**
...
[@anderson1978], tales como, el control de poblaciones de la microflora, la fragmentación de la hojarasca, la 
